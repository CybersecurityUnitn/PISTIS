...
/* Implement the gdbarch type alignment method, overriding the generic
   alignment algorithm for any type that isn't composed of other types.
   MSP430 has a maximum alignment of 2 bytes.  */
static ULONGEST
...
msp430_gdbarch_init (struct gdbarch_info info, struct gdbarch_list *arches)
{
  ...
  set_gdbarch_type_align (gdbarch, msp430_type_align);
