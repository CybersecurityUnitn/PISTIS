...
/* Symbol meta-information handling macros follow the same format as the above
   relocation handling macros.  */
#define ELF32_SMI_SYM(i)	ELF32_R_SYM(i)
#define ELF32_SMI_KIND(i)	ELF32_R_TYPE(i)
#define ELF32_SMI_INFO(s,k)	ELF32_R_INFO(s,k)

#define ELF64_SMI_SYM(i)	ELF64_R_SYM(i)
#define ELF64_SMI_KIND(i)	ELF64_R_TYPE(i)
#define ELF64_SMI_INFO(s,k)	ELF64_R_INFO(s,k)
