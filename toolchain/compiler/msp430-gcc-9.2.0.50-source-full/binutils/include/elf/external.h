...
/* Symbol meta-information entries */
typedef struct {
  unsigned char smi_info[4];	/* Index and kind of metainfo */
  unsigned char smi_value[4];	/* Meaning of value is dependent on the kind */
} Elf32_External_SymMetaInfo;

typedef struct {
  unsigned char smi_info[8];	/* Index and kind of metainfo */
  unsigned char smi_value[8];	/* Meaning of value is dependent on the kind */
} Elf64_External_SymMetaInfo;
