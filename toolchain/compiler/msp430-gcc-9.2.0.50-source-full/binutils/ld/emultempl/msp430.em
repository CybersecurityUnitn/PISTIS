		       ...
		       lang_output_section_statement_type * old_os)
{
  ...
  while (curr != NULL)
	...
	case lang_input_section_enum:
	  ...
	  if (is == s)
	    {
	      /* FIXME: We should create a new wild statement and put the
		 either sections within that instead of just attaching to the
		 output section children.  */
	      lang_statement_list_type *old_list =
		(lang_statement_list_type *)&old_os->children;
	      s->output_section = NULL;
	      lang_add_section (& (new_os->children), s, NULL,
				new_os);
