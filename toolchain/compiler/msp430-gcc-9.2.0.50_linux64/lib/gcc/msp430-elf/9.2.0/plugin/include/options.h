...
#endif
#ifdef GENERATOR_FILE
extern enum msp430_cpu_types target_cpu;
#else
  enum msp430_cpu_types x_target_cpu;
...
#endif
#ifdef GENERATOR_FILE
extern int msp430_max_inline_shift;
#else
  int x_msp430_max_inline_shift;
#define msp430_max_inline_shift global_options.x_msp430_max_inline_shift
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_minrt;
#define x_VAR_minrt do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mno_gc;
#define x_VAR_mno_gc do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mrelax;
...
#define MASK_LARGE (1U << 3)
#define MASK_TINY_PRINTF (1U << 4)
#define MASK_USE_LOWER_REGION_PREFIX (1U << 5)
...
#define TARGET_TINY_PRINTF ((target_flags & MASK_TINY_PRINTF) != 0)
#define TARGET_TINY_PRINTF_P(target_flags) (((target_flags) & MASK_TINY_PRINTF) != 0)
#define TARGET_USE_LOWER_REGION_PREFIX ((target_flags & MASK_USE_LOWER_REGION_PREFIX) != 0)
#define TARGET_USE_LOWER_REGION_PREFIX_P(target_flags) (((target_flags) & MASK_USE_LOWER_REGION_PREFIX) != 0)
...
enum opt_code
{
  ...
  OPT_mOs = 1274,                            /* -mOs */
  OPT_masm_hex = 1275,                       /* -masm-hex */
  OPT_mcode_region_ = 1276,                  /* -mcode-region= */
  OPT_mcpu_ = 1277,                          /* -mcpu= */
  OPT_mdata_region_ = 1278,                  /* -mdata-region= */
  OPT_mdevices_csv_loc_ = 1279,              /* -mdevices-csv-loc= */
  OPT_mdisable_device_warnings = 1280,       /* -mdisable-device-warnings */
  OPT_mhwmult_ = 1281,                       /* -mhwmult= */
  OPT_minrt = 1282,                          /* -minrt */
  OPT_mlarge = 1283,                         /* -mlarge */
  OPT_mmax_inline_shift_ = 1284,             /* -mmax-inline-shift= */
  OPT_mmcu_ = 1285,                          /* -mmcu= */
  OPT_mno_gc = 1286,                         /* -mno-gc */
  OPT_mrelax = 1287,                         /* -mrelax */
  OPT_msilicon_errata_warn_ = 1288,          /* -msilicon-errata-warn= */
  OPT_msilicon_errata_ = 1289,               /* -msilicon-errata= */
  OPT_msim = 1290,                           /* -msim */
  OPT_msmall = 1291,                         /* -msmall */
  OPT_mtiny_printf = 1292,                   /* -mtiny-printf */
  OPT_muse_lower_region_prefix = 1293,       /* -muse-lower-region-prefix */
  OPT_mwarn_mcu = 1294,                      /* -mwarn-mcu */
  OPT_n = 1295,                              /* -n */
  OPT_no_canonical_prefixes = 1296,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1297,              /* -no-integrated-cpp */
  OPT_no_pie = 1298,                         /* -no-pie */
  OPT_nocpp = 1299,                          /* -nocpp */
  OPT_nodefaultlibs = 1300,                  /* -nodefaultlibs */
  OPT_nolibc = 1301,                         /* -nolibc */
  OPT_nophoboslib = 1302,                    /* -nophoboslib */
  OPT_nostartfiles = 1303,                   /* -nostartfiles */
  OPT_nostdinc = 1304,                       /* -nostdinc */
  OPT_nostdinc__ = 1305,                     /* -nostdinc++ */
  OPT_nostdlib = 1306,                       /* -nostdlib */
  OPT_o = 1307,                              /* -o */
  OPT_p = 1308,                              /* -p */
  OPT_pass_exit_codes = 1309,                /* -pass-exit-codes */
  /* OPT_pedantic = 1310, */                 /* -pedantic */
  OPT_pedantic_errors = 1311,                /* -pedantic-errors */
  OPT_pg = 1312,                             /* -pg */
  OPT_pie = 1313,                            /* -pie */
  OPT_pipe = 1314,                           /* -pipe */
  OPT_print_file_name_ = 1315,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1316,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1317,          /* -print-multi-directory */
  OPT_print_multi_lib = 1318,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1319,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1320,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1321,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1322,               /* -print-prog-name= */
  OPT_print_search_dirs = 1323,              /* -print-search-dirs */
  OPT_print_sysroot = 1324,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1325,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1326,                          /* -quiet */
  OPT_r = 1327,                              /* -r */
  OPT_remap = 1328,                          /* -remap */
  OPT_s = 1329,                              /* -s */
  OPT_save_temps = 1330,                     /* -save-temps */
  OPT_save_temps_ = 1331,                    /* -save-temps= */
  OPT_shared = 1332,                         /* -shared */
  OPT_shared_libgcc = 1333,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1334,               /* -shared-libphobos */
  /* OPT_specs = 1335, */                    /* -specs */
  OPT_specs_ = 1336,                         /* -specs= */
  OPT_static = 1337,                         /* -static */
  OPT_static_libasan = 1338,                 /* -static-libasan */
  OPT_static_libgcc = 1339,                  /* -static-libgcc */
  OPT_static_libgfortran = 1340,             /* -static-libgfortran */
  OPT_static_libgo = 1341,                   /* -static-libgo */
  OPT_static_liblsan = 1342,                 /* -static-liblsan */
  OPT_static_libmpx = 1343,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1344,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1345,               /* -static-libphobos */
  OPT_static_libstdc__ = 1346,               /* -static-libstdc++ */
  OPT_static_libtsan = 1347,                 /* -static-libtsan */
  OPT_static_libubsan = 1348,                /* -static-libubsan */
  OPT_static_pie = 1349,                     /* -static-pie */
  /* OPT_std_c__03 = 1350, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1351, */                /* -std=c++0x */
  OPT_std_c__11 = 1352,                      /* -std=c++11 */
  OPT_std_c__14 = 1353,                      /* -std=c++14 */
  OPT_std_c__17 = 1354,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1355, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1356, */                /* -std=c++1z */
  OPT_std_c__2a = 1357,                      /* -std=c++2a */
  OPT_std_c__98 = 1358,                      /* -std=c++98 */
  OPT_std_c11 = 1359,                        /* -std=c11 */
  OPT_std_c17 = 1360,                        /* -std=c17 */
  /* OPT_std_c18 = 1361, */                  /* -std=c18 */
  /* OPT_std_c1x = 1362, */                  /* -std=c1x */
  OPT_std_c2x = 1363,                        /* -std=c2x */
  /* OPT_std_c89 = 1364, */                  /* -std=c89 */
  OPT_std_c90 = 1365,                        /* -std=c90 */
  OPT_std_c99 = 1366,                        /* -std=c99 */
  /* OPT_std_c9x = 1367, */                  /* -std=c9x */
  OPT_std_f2003 = 1368,                      /* -std=f2003 */
  OPT_std_f2008 = 1369,                      /* -std=f2008 */
  OPT_std_f2008ts = 1370,                    /* -std=f2008ts */
  OPT_std_f2018 = 1371,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1381,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1382,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1383,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1384,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1385, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1386, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1387,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1388, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1389,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1390,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1391, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1392, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1393,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1394, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1395, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1396, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1397, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1398, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1399,                     /* -std=legacy */
  OPT_symbolic = 1400,                       /* -symbolic */
  OPT_t = 1401,                              /* -t */
  OPT_time = 1402,                           /* -time */
  OPT_time_ = 1403,                          /* -time= */
  OPT_traditional = 1404,                    /* -traditional */
  OPT_traditional_cpp = 1405,                /* -traditional-cpp */
  OPT_trigraphs = 1406,                      /* -trigraphs */
  OPT_u = 1407,                              /* -u */
  OPT_undef = 1408,                          /* -undef */
  OPT_v = 1409,                              /* -v */
  OPT_version = 1410,                        /* -version */
  OPT_w = 1411,                              /* -w */
  OPT_wrapper = 1412,                        /* -wrapper */
  OPT_x = 1413,                              /* -x */
  OPT_z = 1414,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
