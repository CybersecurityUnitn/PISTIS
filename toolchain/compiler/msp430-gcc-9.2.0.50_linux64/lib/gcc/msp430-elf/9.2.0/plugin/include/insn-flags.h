...
#define HAVE_aashlhi3_430 (!msp430x)
#define HAVE_aashrhi3_430 (!msp430x)
#define HAVE_alshrhi3_430 (!msp430x)
...
#define HAVE_mulsidi3 (optimize > 2 && msp430_has_hwmult ())
#define HAVE_umulsidi3 (optimize > 2 && msp430_has_hwmult ())
#define HAVE_movsi 1
...
extern rtx        gen_aashlhi3_430             (rtx, rtx, rtx);
extern rtx        gen_aashrhi3_430             (rtx, rtx, rtx);
extern rtx        gen_alshrhi3_430             (rtx, rtx, rtx);
